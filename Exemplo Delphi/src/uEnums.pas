...
begin
   case PWFinancingTypes of
       vNaoDefinido:                  Result := 'vNaoDefinido';
       aVista:                        Result := 'aVista';
       parceladoEmissor:              Result := 'parceladoEmissor';
       parceladoEstabelecimento:      Result := 'parceladoEstabelecimento';
       preDatado:                     Result := 'preDatado';
   end;
end;
...
begin
   case PWCardTypes of
       naoDefinido:  Result := 'naoDefinido';
...
case PWPPEVT  of
  ...
  PWPPEVT_MAGSTRIPE  :   Result := 'PWPPEVT_MAGSTRIPE';
  PWPPEVT_ICC        :   Result := 'PWPPEVT_ICC';
  PWPPEVT_CTLS       :   Result := 'PWPPEVT_CTLS';
  PWPPEVT_KEYCONF    :   Result := 'PWPPEVT_KEYCONF';
  PWPPEVT_KEYBACKSP  :   Result := 'PWPPEVT_KEYBACKSP';
  PWPPEVT_KEYCANC    :   Result := 'PWPPEVT_KEYCANC';
  PWPPEVT_KEYF1      :   Result := 'PWPPEVT_KEYF1';
  PWPPEVT_KEYF2      :   Result := 'PWPPEVT_KEYF2';
